class ChallengesController < ApplicationController
  ...
  private
    ...
    def challenge_params
      params.require(:challenge).permit(:name, :challenge_type_id, :num_type, :num_in_type, :start_date, :end_date, :organization_id, :description, :rule_qualifies_attributes, :rule_totals_attributes, :rule_eaches_attributes)
    end
end
