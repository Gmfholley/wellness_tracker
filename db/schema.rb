...
ActiveRecord::Schema.define(version: 20150818223228) do
  ...
  add_index "challenge_participants", ["user_id", "challenge_id"], name: "index_challenge_participants_on_user_id_and_challenge_id", unique: true
